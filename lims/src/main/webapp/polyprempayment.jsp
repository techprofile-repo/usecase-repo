...
rs=DBConn.executeQuery("select c.custid,c.policyid,c.premiumtype,c.premiumamount,c.expirydate,d.nextpremiumdate from custpolicies c,custpremiumdates d where d.custpolicyid=c.custpolicyid and  c.custpolicyid=" + cupid);
