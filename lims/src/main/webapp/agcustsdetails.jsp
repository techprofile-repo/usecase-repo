...
rs=DBConn.executeQuery("select * from  customer where custid in(select custid from custpolicies where agentid="+ aid+")");

%>

  <p align="center"><strong><font color="#66FF66" size="5"><em>AGENT CUSTOMERS 
    PERSONAL DETAILS</em></font></strong></p>
...
{ %>
    <tr> 
      ...
      <td width="138"><%=rs.getString(7)%> <div align="center"></div></td>
      <td width="92"><%=rs.getString(8)%> <div align="center"></div></td>
