...
con=DBConn.getConnection();
 rs=DBConn.executeQuery("select custid from customer");
 rs1=DBConn.executeQuery("select policyid from policies");
  rs2=DBConn.executeQuery("select agentid from agents");
