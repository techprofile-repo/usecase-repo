...
System.out.println("before cstmt"+  aid);

rs=DBConn.executeQuery("select * from agentcommtx where AGENTCOMMTXID=(select max(AGENTCOMMTXID) from agentcommtx where agentid="+ aid + ")" );
