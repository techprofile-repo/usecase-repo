...
{ %>
    <tr> 
      ...
      <td width="38"><%=rs.getInt(4)%> <div align="center"></div></td>
      ...
      <td width="134"><%=rs.getString(8)%> <div align="center"></div></td>
      <td width="96"><%=rs.getDate(9)%> <div align="center"></div></td>
      <td width="81"><%=rs.getInt(10)%></td>
      <td width="88"><%=rs.getInt(11)%></td>
    </tr>
    <% }%>
  </table>
  <p>&nbsp;</p>
